data1=read.csv(file="C:/Users/MONDAL/Desktop/SEM 6/Project/Final/westcentral.csv")           #read the file
data1
matplot(data1[,1:2],data1[,3],type="l",xlab="Year--->",ylab="West Central India Rainfall",main="Time Series Plot")                                                    
matplot(data1[,1:2],data1[,4],type="l",xlab="Year--->",ylab="Moving Average",main="Plot for Moving Average")                                                   
Org=data1$West.Central                                                             #Amount of Rainfall
